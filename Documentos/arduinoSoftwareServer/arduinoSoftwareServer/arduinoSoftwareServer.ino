...
void setup() {
  ...
  /* Configuração dos Pinos para receber os comandos do sistema */
  ...
  /* Inicializa as variáveis todas em nivel baixo sem carga, no entanto por ser uma estrutur NPN sem carga = HIGH */
...
void loop() {
  ...
  if (client) {
    ...
    while (client.connected()) {
      ...
      /*Dependendo do formato Modbus TCP temos equipamentos que começam com 0 ou 1, então temos os seguinte
        possiveis endereços, todos listados com os equivamentes para acesso no formato Decimal*/
