    ...
    class CRUD
    {
        ...
        public void SaveConfig(int n_IdUnicoConfig, DateTime d_DataConfig, string c_IpArduinoConfig, int[] comboType, int[] comboCol, int[] comboRow, int[] watts) {
            ...
            string QuerySql = "INSERT INTO controleambientesdb.config(n_IdUnicoConfig, d_DataConfig, c_IpArduinoConfig, " +
                ...
                "n_txtWats_47Config, n_txtWats_48Config, n_txtWats_49Config, n_txtWats_50Config, n_txtWats_51Config) Values (" + n_IdUnicoConfig + ",'" + d_DataConfig.ToString("yyyy/MM/dd HH:mm:ss") + "','" + c_IpArduinoConfig + "'," + comboType[0] + "," + comboType[1] + "," + comboType[2] + "," + comboType[3] +
                "," + comboType[4] + "," + comboType[5] + "," + comboType[6] + "," + comboType[7] + "," + comboType[8] + "," + comboType[9] + "," + comboType[10] + "," + comboType[11] + "," + comboType[12] + "," + comboType[13] +
                "," + comboType[14] + "," + comboType[15] + "," + comboType[16] + "," + comboType[17] + "," + comboType[18] + "," + comboType[19] + "," + comboType[20] + "," + comboType[21] + "," + comboType[22] + "," + comboType[23] +
                "," + comboType[24] + "," + comboType[25] + "," + comboType[26] + "," + comboType[27] + "," + comboType[28] + "," + comboType[29] + "," + comboType[30] + "," + comboType[31] + "," + comboType[32] + "," + comboType[33] +
                "," + comboType[34] + "," + comboType[35] + "," + comboType[36] + "," + comboType[37] + "," + comboType[38] + "," + comboType[39] + "," + comboType[40] + "," + comboType[41] + "," + comboType[42] + "," + comboType[43] +
                "," + comboType[44] + "," + comboType[45] + "," + comboType[46] + "," + comboType[47] + "," + comboType[48] + "," + comboType[49] + "," + comboType[50] + "," + comboType[51] + "," + comboType[52] + "," + comboType[53] +
                "," + comboCol[0] + "," + comboCol[1] + "," + comboCol[2] + "," + comboCol[3] + "," + comboCol[4] + "," + comboCol[5] + "," + comboCol[6] + "," + comboCol[7] + "," + comboCol[8] + "," + comboCol[9] + "," + comboCol[10] +
                "," + comboCol[11] + "," + comboCol[12] + "," + comboCol[13] + "," + comboCol[14] + "," + comboCol[15] + "," + comboCol[16] + "," + comboCol[17] + "," + comboCol[18] + "," + comboCol[19] + "," + comboCol[20] + "," + comboCol[21] +
                "," + comboCol[22] + "," + comboCol[23] + "," + comboCol[24] + "," + comboCol[25] + "," + comboCol[26] + "," + comboCol[27] + "," + comboCol[28] + "," + comboCol[29] + "," + comboCol[30] + "," + comboCol[31] + "," + comboCol[32] +
                "," + comboCol[33] + "," + comboCol[34] + "," + comboCol[35] + "," + comboCol[36] + "," + comboCol[37] + "," + comboCol[38] + "," + comboCol[39] + "," + comboCol[40] + "," + comboCol[41] + "," + comboCol[42] + "," + comboCol[43] +
                "," + comboCol[44] + "," + comboCol[45] + "," + comboCol[46] + "," + comboCol[47] + "," + comboCol[48] + "," + comboCol[49] + "," + comboCol[50] + "," + comboCol[51] + "," + comboCol[52] + "," + comboCol[53] + "," + comboRow[0] +
                "," + comboRow[1] + "," + comboRow[2] + "," + comboRow[3] + "," + comboRow[4] + "," + comboRow[5] + "," + comboRow[6] + "," + comboRow[7] + "," + comboRow[8] + "," + comboRow[9] + "," + comboRow[10] + "," + comboRow[11] +
                "," + comboRow[12] + "," + comboRow[13] + "," + comboRow[14] + "," + comboRow[15] + "," + comboRow[16] + "," + comboRow[17] + "," + comboRow[18] + "," + comboRow[19] + "," + comboRow[20] + "," + comboRow[21] + "," + comboRow[22] +
                "," + comboRow[23] + "," + comboRow[24] + "," + comboRow[25] + "," + comboRow[26] + "," + comboRow[27] + "," + comboRow[28] + "," + comboRow[29] + "," + comboRow[30] + "," + comboRow[31] + "," + comboRow[32] + "," + comboRow[33] +
                "," + comboRow[34] + "," + comboRow[35] + "," + comboRow[36] + "," + comboRow[37] + "," + comboRow[38] + "," + comboRow[39] + "," + comboRow[40] + "," + comboRow[41] + "," + comboRow[42] + "," + comboRow[43] + "," + comboRow[44] +
                "," + comboRow[45] + "," + comboRow[46] + "," + comboRow[47] + "," + comboRow[48] + "," + comboRow[49] + "," + comboRow[50] + "," + comboRow[51] + "," + comboRow[52] + "," + comboRow[53] + "," + watts[0] + "," + watts[1] +
                "," + watts[2] + "," + watts[3] + "," + watts[4] + "," + watts[5] + "," + watts[6] + "," + watts[7] + "," + watts[8] + "," + watts[9] + "," + watts[10] + "," + watts[11] + "," + watts[12] + "," + watts[13] + "," + watts[14] +
                "," + watts[15] + "," + watts[16] + "," + watts[17] + "," + watts[18] + "," + watts[19] + "," + watts[20] + "," + watts[21] + "," + watts[22] + "," + watts[23] + "," + watts[24] + "," + watts[25] + "," + watts[26] +
                "," + watts[27] + "," + watts[28] + "," + watts[29] + "," + watts[30] + "," + watts[31] + "," + watts[32] + "," + watts[33] + "," + watts[34] + "," + watts[35] + "," + watts[36] + "," + watts[37] + "," + watts[38] +
                "," + watts[39] + "," + watts[40] + "," + watts[41] + "," + watts[42] + "," + watts[43] + "," + watts[44] + "," + watts[45] + "," + watts[46] + "," + watts[47] + "," + watts[48] + "," + watts[49] + "," + watts[50] +
                "," + watts[51] + "," + watts[52] + "," + watts[53] + ")";
